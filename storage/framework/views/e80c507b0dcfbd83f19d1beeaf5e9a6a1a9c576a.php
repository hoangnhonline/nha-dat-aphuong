...
<div id="advLeft" style="display:none">
  <div class="banner_scroll" id="banner_left">
    <div class="item">        
      ...
      <?php endif; ?>        
                  <img src="<?php echo e(Helper::showImage($banner->image_url)); ?>" alt="quang cao ben trai cahatvui.com">
              <?php if($banner->ads_url !=''): ?>
      </a>
      <?php endif; ?>
      <?php endforeach; ?>
...
<div id="advRight" style="display:none">
  <div class="banner_scroll" id="banner_right">
    <div class="item">
      ...
      <?php endif; ?>        
                  <img src="<?php echo e(Helper::showImage($banner->image_url)); ?>" alt="quang cao ben phai cahatvui.com">
              <?php if($banner->ads_url !=''): ?>
      </a>
      <?php endif; ?>
      <?php endforeach; ?>
