...
<html lang="en-US">
    <head>
        ...
        <link rel="icon" href="<?php echo e(URL::asset('assets/img/favicon.ico')); ?>" type="image/x-icon">
        <link rel="shortcut icon" href="<?php echo e(URL::asset('assets/img/favicon.png')); ?>" type="image/png">
        <link rel="stylesheet" href="<?php echo e(URL::asset('assets/css/bootstrap.css')); ?>" type="text/css">
        <link rel="stylesheet" href="<?php echo e(URL::asset('assets/css/bootstrap-responsive.css')); ?>" type="text/css">
        <link rel="stylesheet" href="<?php echo e(URL::asset('assets/libraries/chosen/chosen.css')); ?>" type="text/css">
        <link rel="stylesheet" href="<?php echo e(URL::asset('assets/libraries/bootstrap-fileupload/bootstrap-fileupload.css')); ?>" type="text/css">
        <link rel="stylesheet" href="<?php echo e(URL::asset('assets/libraries/jquery-ui-1.10.2.custom/css/ui-lightness/jquery-ui-1.10.2.custom.min.css')); ?>" type="text/css">
        <link rel="stylesheet" href="<?php echo e(URL::asset('assets/css/realia-blue.css')); ?>" type="text/css" id="color-variant-default">
    ...
    <body>
            ...
            <div id="wrapper">
                <div id="wrapper-inner">
                                            ...
                                            <div class="row">
                                                <div class="logo-wrapper span4">
                                                    ...
                                                    <div class="logo">
                                                        ...
                                                        <img src="<?php echo e(URL::asset('assets/img/logo.png')); ?>" alt="Home">
                                                        </a>
                                                    </div>
                                                    <!-- /.logo -->
                                                    <div class="site-name">
                    ...
                    <div id="content">
                        ...
                        <!-- /.map-wrapper -->
                        <?php echo $__env->yieldContent('noi_bat'); ?>
                                    ...
                                    <div class="content">
                                        <div class="property">
                                            <div class="image">
                                                ...
                                                <img src="<?php echo e(URL::asset('assets/img/tmp/property-small-1.png')); ?>" alt="">
                                            </div>
                                            <!-- /.image -->
                                            <div class="wrapper">
                                                <div class="title">
                                        ...
                                        <div class="property">
                                            <div class="image">
                                                <a href="detail.html"></a>
                                                <img src="<?php echo e(URL::asset('assets/img/tmp/property-small-3.png')); ?>" alt="">
                                            </div>
                                            <!-- /.image -->
                                            <div class="wrapper">
                                                <div class="title">
        ...
        <script type="text/javascript" src="<?php echo e(URL::asset('assets/js/jquery.ezmark.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(URL::asset('assets/js/jquery.currency.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(URL::asset('assets/js/jquery.cookie.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(URL::asset('assets/js/retina.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(URL::asset('assets/js/bootstrap.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(URL::asset('assets/js/carousel.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(URL::asset('assets/js/gmap3.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(URL::asset('assets/js/gmap3.infobox.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(URL::asset('assets/libraries/jquery-ui-1.10.2.custom/js/jquery-ui-1.10.2.custom.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(URL::asset('assets/libraries/chosen/chosen.jquery.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(URL::asset('assets/libraries/iosslider/_src/jquery.iosslider.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(URL::asset('assets/libraries/bootstrap-fileupload/bootstrap-fileupload.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(URL::asset('assets/js/realia.js')); ?>"></script>
    </body>
</html>