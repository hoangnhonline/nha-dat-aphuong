<?php if( !empty( $rsUpload )): ?>
	...
	<div class="col-md-3">
	    ...
	    <button class="btn btn-danger btn-sm remove-image" type="button" data-value="<?php echo e($tmp['image_path']); ?>" data-id="" ><span class="glyphicon glyphicon-trash"></span></button>
	  </div>
	</div>
	<?php endforeach; ?>
<?php endif; ?>