...
<div id="advLeft" style="display:none">
  <div class="banner_scroll" id="banner_left">
    <div class="item">        
      ...
      @endif        
                  <img src="{{ Helper::showImage($banner->image_url) }}" alt="quang cao ben trai cahatvui.com">
              @if($banner->ads_url !='')
      </a>
      @endif
      @endforeach
...
<div id="advRight" style="display:none">
  <div class="banner_scroll" id="banner_right">
    <div class="item">
      ...
      @endif        
                  <img src="{{ Helper::showImage($banner->image_url) }}" alt="quang cao ben phai cahatvui.com">
              @if($banner->ads_url !='')
      </a>
      @endif
      @endforeach
